...
class DbRepo:
    ...
    def drop_all_tables(self):
        ...
        self.local_session.execute('DROP TABLE tourists CASCADE')
        self.local_session.execute('DROP TABLE attractions CASCADE')
        self.local_session.execute('DROP TABLE visits CASCADE')
        self.local_session.commit()
